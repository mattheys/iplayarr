    ...
    <div>
      <div class="panel">
        ...
        <div v-if="forgot" class="panel-body">
          ...
          <div class="form-group">
            <input v-model="forgotForm.key" type="text" class="form-input" placeholder="Code from Console" @keyup.enter="submitForgot">
          </div>
          <div class="forgot-container">
            <a href="#" @click="hideForgot">Cancel</a>
          </div>
          <button type="button" class="button" @click="submitForgot">
            Reset
          </button>
        </div>
      </div>
