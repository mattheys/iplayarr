  ...
  <div class="NavBar">
    <div class="left">
      <div class="logoPanel">
        ...
        <font-awesome-icon v-if="authState.user" class="mobileOnly clickable burgerMenu" :icon="['fas', 'bars']" @click="toggleLeftHandNav" />
      </div>
    </div>
    <div class="middle">
    ...
    <div class="right">
      <a v-if="!hiddenSettings.HIDE_DONATE" href="https://ko-fi.com/nikorag" aria-label="Donate" class="desktopOnly donateLink" target="_blank">
